...
### Treatments (spec-driven practices)

- **Spec Therapy** — Teaching humans to write clear specifications before coding
- **Context Infusion** — IV drip of background docs, tech stack info, and standards
- **Boundary Setting** — Helping humans define scope and stick to it
- **Trust Exercises** — Humans learn to let agents work without hovering

### Clinic Staff

- **The Spec Doctor** — Diagnoses ailments and prescribes specification treatments
- **The Context Nurse** — Administers background info and standards
- **The Triage Bot** — Assesses incoming cases and prioritizes treatment
- **Reception** — Cheerfully greets agent patients booking their appointments
